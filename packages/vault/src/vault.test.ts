...
describe("Vault Package", () => {
  ...
  test("Test 5: Retrieve Entry", () => {
    const entry1 = { id: "entry-1", site: "s1", username: "u1", password: "p1" };
    const entry2 = { id: "entry-2", site: "s2", username: "u2", password: "p2" };
  ...
  test("Test 7: Delete Entry", () => {
    vault.entries.push({ id: "entry-1", site: "s1", username: "u1", password: "p1" });
